...
\midrule
\multicolumn{2}{@{}l}{\textbf{Scene completion (Ch.~\ref{ch:6_Scene_Completion})}~\cite{vermandere_semantic_2024, suvorov_resolution-robust_2022}} \\
\cmidrule(r){1-1}
...
\midrule
\multicolumn{2}{@{}l}{\textbf{Object completion (Ch.~\ref{ch:7_Object_Completion})}~\cite{mittal_autosdf_2022, hunyuan3d_hunyuan3d-omni_2025, vermandere_geometry_2025}} \\
\cmidrule(r){1-1}
...
\midrule
\multicolumn{2}{@{}l}{\textbf{Scene dynamification (Ch.~\ref{ch:8_Scene_Dynamification})}~\cite{wei_approximate_2022, vermandere_adaptive_2026}} \\
\cmidrule(r){1-1}
