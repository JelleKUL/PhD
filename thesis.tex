...
\newcommand{\chapteropener}[3]{%
  ...
  \vspace*{\fill}
  \begin{center}
    {\sffamily\Huge\bfseries #1}\\[1cm]     % number only, big, matches chapter heading font (sans, bold)
    \includegraphics[width=\textwidth]{#3}\\[0.5cm]
    {\sffamily\Huge\bfseries #2}             % chapter title, same font family/weight
  \end{center}
  \vspace*{\fill}
